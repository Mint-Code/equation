...
Fraction result = (Fraction) (Equation.power(num, 2));
    ...
    /**
     * reciprocalOf方法 - 返回所传入分数的倒数。
     * <p>您可以直接使用该方法，也可以使用Fraction对象内置的方法。<p>
     * <blockquote><pre>
...
Fraction result2 = Equation.reciprocolOf(frac); //这里运算的结果和上面相等
     * </pre></blockquote>
     * @param frac - Fraction - 希望获得其倒数的分数
     * @return Fraction - 传入分数的倒数。
     * @see equation.Fraction#reciprocalOf()
     */
    public static Fraction reciprocolOf(Fraction frac) {
        return frac.reciprocalOf();
    }
}
